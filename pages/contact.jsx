...
export default function ContactPage() {
  return (
    <>
      <Head>
        <title>KVL Communications - Contact us</title>
      </Head>
          ...
          <div className='relative px-6 pb-20 pt-12 sm:pt-32 lg:static lg:px-8 lg:py-48'>
            <div className='mx-auto max-w-xl lg:mx-0 lg:max-w-lg'>
              ...
              <p className='mt-6 text-lg leading-8 text-gray-600'>
                Get in contact with a sales representative to learn more about
                our products and services. We will respond shortly.
              </p>
